/*
  Copyright (c) 2017 - Scarnà Angelo
...
void MimeMessage::setDispositionNotification(const QString& notifier)
{
...
const QString & MimeMessage::getDispositionNotification() const
{
    return notifier;
}
...
QString MimeMessage::toString()
{
    ...
    /* ---------------------------------- */
        ...
        /* ---------- Sender / Notification ----------- */
        mime += "Disposition-Notification-To:";
        if (sender->getName() != "")
        {
            switch (hEncoding)
            {
